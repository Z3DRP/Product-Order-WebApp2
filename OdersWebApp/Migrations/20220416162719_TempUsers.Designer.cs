...
namespace OdersWebApp.Migrations
{
    ...
    [Migration("20220416162719_TempUsers")]
    partial class TempUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OdersWebApp.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("OdersWebApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("OdersWebApp.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OdersWebApp.Models.TempUser", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OdersWebApp.Models.User", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OdersWebApp.Models.OrderedProduct", b =>
                {
                    b.HasBaseType("OdersWebApp.Models.Product");
            ...
            modelBuilder.Entity("OdersWebApp.Models.Order", b =>
                {
                    b.HasOne("OdersWebApp.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("OdersWebApp.Models.OrderedProduct", b =>
                {
                    b.HasOne("OdersWebApp.Models.Order", null)
                        .WithMany("Product")
